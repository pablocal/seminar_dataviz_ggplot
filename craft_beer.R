...
# Utiliza las tres funciones para explorar los datos. Para ello, completa
# y ejecuta el código:
...
# Ahora completa y ejecuta el código:
plot_beer <- ggplot(data = ____, mapping = aes(x = ___, __ = _____, ___ = _____)) +
  geom_point()
...
plot_beer <- plot_beer + _______(___ = ___, ___ = _______, ___ = _____)
...
plot_beer <- plot_beer + labs(title = "Grab a beer",
